...
> Прежде чем запустить бота, необходимо провести настройку конфигурации в файле variables.py и задать правильные параметры, а также в /config/webhook_cfg.py
